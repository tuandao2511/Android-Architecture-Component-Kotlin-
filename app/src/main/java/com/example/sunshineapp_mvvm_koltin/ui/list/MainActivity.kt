...
import com.example.sunshineapp_mvvm_koltin.ui.detail.DetailActivity
import com.example.sunshineapp_mvvm_koltin.ui.dialog.WeatherLocationDialog
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mMainActivityViewModel.getListWeatherEntry()!!.observe(this, Observer { weatherEntries ->
            mForecastAdapter.swapForecasts(weatherEntries)
